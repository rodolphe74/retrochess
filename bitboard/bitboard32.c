...
uint64_t get_64_from_bboard(bboard32 b)
{
	return (((int64_t)b.a) << 32) | b.b;
}


bboard32 get_bboard_from_64(bboard b)
{
	bboard32 bb = {0, 0};
	bb.a = (int32_t) (b >> 32);
	bb.b = (int32_t) b;
...
//   return pos;
	...
	bboard32 b = get_bboard_from_64(b64);
...
void
squares (bboard b64, int *array, int *n)
{
//   *n = 0;
//   for (int i = 0; i < 64; i++)
//     if (b64 & 1ULL << i)
