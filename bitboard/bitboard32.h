...
#define BLACK_SQUARES 0xaa55aa55aa55aa55
  ...
  const uint64_t mh_k1 = 0x5555555555555555;
  const uint64_t mh_k2 = 0x3333333333333333;
  const uint64_t mh_k3 = 0x0f0f0f0f0f0f0f0f;

  const uint64_t mv_k1 = 0x00ff00ff00ff00ff;
  const uint64_t mv_k2 = 0x0000ffff0000ffff;
...
uint8_t has_only_one_one (bboard b);
// bboard only_white_squares (bboard b);
uint8_t only_white_squares (bboard b);
// bboard only_black_squares (bboard b);
uint8_t only_black_squares (bboard b)
