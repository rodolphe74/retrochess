...
int pseudo_legal_move_ep(Board *board, int from, int to, uint8_t ep[16], int *e);
...
bool try_move_without_notation(Board *board, int from, int to, char promote_in, Board *new_board, char *capture, int en_passant);
